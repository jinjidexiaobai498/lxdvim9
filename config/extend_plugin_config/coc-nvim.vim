...
export def Setup()
	...
	command! -nargs=0 Format    <Cmd>g:CocActionAsync('format')
	command! -nargs=? Fold      <Cmd>g:CocAction('fold', <f-args>)
	command! -nargs=0 OR        <Cmd>g:CocActionAsync('runCommand', 'editor.action.organizeImport')
	...
	nnoremap <silent><nowait> <space>la  <Cmd>CocList diagnostics<cr>
	# Manage extensions
	nnoremap <silent><nowait> <space>le  <Cmd>CocList extensions<cr>
	# Show commands
	nnoremap <silent><nowait> <space>lc  <Cmd>CocList commands<cr>
	# Find symbol of current document
	nnoremap <silent><nowait> <space>lo  <Cmd>CocList outline<cr>
	# Search workspace symbols
	nnoremap <silent><nowait> <space>ls  <Cmd>CocList -I symbols<cr>
	# Do default action for next item
	nnoremap <silent><nowait> <space>lj  <Cmd>CocNext<CR>
	# Do default action for previous item
	nnoremap <silent><nowait> <space>lk  <Cmd>CocPrev<CR>
	# Resume latest coc list
	nnoremap <silent><nowait> <space>lp  <Cmd>CocListResume<CR>
